...
const Project = ({ title, liveDemo, desc, githubLink, image, demoLink = "" }) => {
  return (
    <div className='w-[60vw] h-[60vh] flex items-center'>
      <div className="content w-[60%] h-[50vh] flex flex-col justify-center duration-500 items-center mx-10 border border-zinc-400/50 hover:border-white/100 rounded-xl">
        <h1 className='font-bold text-6xl'>{title}</h1>
        <p className='m-10 flex justify-center'>{desc}</p>
        <div className="links flex">
          <Link href={githubLink} target='_blank'>
            <button className='mx-4 duration:500 bg-gray-600/50 hover:bg-gray-600 duration-500 p-4 flex'>
